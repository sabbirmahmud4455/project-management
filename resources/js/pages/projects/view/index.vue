                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <router-link  :to="{name:'project_view', params:{id: id}}" class="nav-link" active-class="active ">Status</router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link  :to="{name:'project_view_module', params:{id: id}}" class="nav-link" active-class="active">Modules</router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link  :to="{name:'project_view_tasks', params:{id: id}}" class="nav-link" active-class="active">Tasks</router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link  :to="{name:'project_view_details', params:{id: id}}" class="nav-link" active-class="active">Details</router-link>
                                </li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">

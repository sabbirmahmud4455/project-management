                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="details_col">
                            <h4 class="title">Sprint Task Update</h4>
                            <form
...
export default {
    data() {
        return {
            ...
            form: new Form({
                sprint_task_id: this.$route.params.id,
                priority: null,
                status: null,
                project_id: 0,
                images: [],
    ...
    methods: {
        getSprint_task() {
            axios
                .get(`/api/sprint/sprint-task/${this.$route.params.id}/edit`)
                .then(response => {
                    this.form.name = response.data.task.name;

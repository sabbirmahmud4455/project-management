        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <table class="table table-striped table-bordered projects">
                    ...
                    <tbody>
                        <tr v-if="admin_users.data.length" v-for="(user, index) in admin_users.data" :key="index">
                            <td>
                                {{index+1}}
                            </td>
                            <td>
            ...
            <div class="card-footer clearfix">
                <pagination :data="admin_users" :limit=2 align='center'  @pagination-change-page="getUser">
...
export default {
    ...
    methods:{
        getUser(page){
            ...
            axios.get('/api/users/admin?page=' + page).then(response => {
        ...
        userDelete(data, index){
            axios.delete(`/api/user/${data.id}`).then( res=>{
                ...
                this.admin_users.data.splice(index, 1);

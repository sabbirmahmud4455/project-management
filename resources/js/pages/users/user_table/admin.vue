        ...
        <div class="card card-primary">
            <div class="card-header d-flex">
                ...
                <div class="ml-auto d-flex">
                    <router-link  :to="{name:'users'}" class="nav-link" active-class="active">All User</router-link>
                    <router-link  :to="{name:'users_admin'}" class="nav-link" active-class="active">Admin</router-link>
                    <router-link  :to="{name:'users_member'}" class="nav-link" active-class="active">Member</router-link>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">

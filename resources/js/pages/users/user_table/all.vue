        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <table class="table table-striped table-bordered projects">
                    ...
                    <tbody>
                        <tr v-if="all_users.data.length" v-for="(user, index) in all_users.data" :key="index">
                            <td>
                                {{index+1}}
                            </td>
                            <td>
            ...
            <div class="card-footer clearfix">
                <pagination :data="all_users" :limit=2 align='center'  @pagination-change-page="getUser">

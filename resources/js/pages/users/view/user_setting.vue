        ...
        <div class="col-md-6 col-12">
          <div class="form-group">
            <label for="emergency_contact_person">
              Emergency contact (Other person)</label
            >
            <input
              ...
              :class="{
                'is-invalid': form.errors.has('emergency_contact_person'),
              }"
            />
            <has-error
              :form="form"
        ...
        <div class="col-12">
          <div class="form-group">
            ...
            <input
              ...
              :class="{ 'is-invalid': form.errors.has('present_address') }"
            />
...
export default {
  ...
  methods: {
    editProfile() {
      ...
      axios.get(`/api/profile/edit/${id}`).then((response) => {
        if (response.data[0]) {
          ...
          this.form.emergency_contact_person =
            response.data[0].emergency_contact_person;
        }
      });
    },
    updateProfile() {
      ...
      let all = {
        ...
        emergency_contact_person: this.form.emergency_contact_person,
      };
      axios
        .put(`/api/profile/update/${id}`, all)
        .then((response) => {
          this.$toast.success({
            title: "SUCCESS",
    ...
    createProfile() {
      ...
      axios
        .post(`/api/profile/create/${id}`, all)
        .then((response) => {
          this.$toast.success({
            title: "SUCCESS",
            message: "Updated Successfully",

                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-6 col">
                                    <div class="form-group">
                                        ...
                                        <img v-else style="max-width:35px; margin-left:2%; border-radius:5%;" :src="real_photo" alt="user photo">
                                        </div>
                                    </div>
                                </div>
                                <div class='col-12'>
                                ...
                                <div  v-if="form.pass_change=='On'" class="col-md-4 col">
                                    <div class="form-group">
                                        <label for="old_password">Old Password *</label>
                                        <input name="old_password" v-model="form.old_password" type="password" class="form-control" id="old_password" placeholder="Enter Old Password" :class="{ 'is-invalid': form.errors.has('old_password') }">
                                ...
                                <div  v-if="form.pass_change=='On'" class="col-md-4 col">
                                    <div class="form-group">
                                        ...
                                        <input name="password" v-model="form.password" type="password" class="form-control" id="password" placeholder="Enter New Password" :class="{ 'is-invalid': form.errors.has('password') }">
                                ...
                                <div v-if="form.pass_change=='On'" class="col-md-4 col">
                                    <div class="form-group">
                                        ...
                                        <input name="password_confirmation"  v-model="form.password_confirmation" type="password" class="form-control" id="confirm" placeholder="Confirm New Password" :class="{ 'is-invalid': form.errors.has('password_confirmation') }">
    ...
    methods:{
      ...
      updateUser(){
          let id = this.$route.params.id;
            ...
            if (!this.img.photo=='') {
                this.img.post(`/api/users/update/${id}`, {

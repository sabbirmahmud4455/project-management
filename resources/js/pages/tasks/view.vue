                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <li class="list-group-item">
                                <b>Name :</b> <span v-if="name" class="ml-2">{{name}}</span>
                            </li>
                            <li class="list-group-item">
                                <b>Project :</b> 
                                 <span v-if="project_name" class="ml-2">
                            ...
                            <li class="list-group-item">
                                <b>Module :</b> 
                                 <span v-if="module_name" class="ml-2">
                                     <router-link :to="{name:'module_view', params:{id: module_id}}" class=" text-primary">
                                                                                                                    {{module_name}}  
                                    </router-link>
                                </span>
                            </li>

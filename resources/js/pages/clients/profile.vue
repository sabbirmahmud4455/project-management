                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    ...
                                                    <span class="description"
                                                        >Shared publicly - 7:30
                                                        PM today</span
                                                    >
                                                </div>
                                                <!-- /.user-block -->
                                                <p>
                                                    Lorem ipsum represents a
                                                    long-held tradition for
                                                    designers, typographers and
                                                    the like. Some people hate
                                                    it and argue for its demise,
                                                    but others ignore the hate
                                                    as they create awesome tools
                                                    to help create filler text
                                                    for everyone from bacon
                                                    lovers to Charlie Sheen
                                                    fans.
                                                </p>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <h3
                                                            class="timeline-header border-0"
                                                        >
                                                            <a href="#"
                                                                >Sarah Young</a
                                                            >
                                                ...
                                                <div>
                                                    <i
                                                        class="fas fa-comments bg-warning"
                                                    ></i>
        ...
        getUser() {
            ...
            axios.get(`/api/client/${id}`).then(response => {
                ...
                this.emergency_contact_person =
                    response.data.emergency_contact_person;

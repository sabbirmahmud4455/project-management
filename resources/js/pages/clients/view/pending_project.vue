<template lang="">
    <div>
        <div class="row">
            <div v-if="active_projects.data" v-for="(project, index) in active_projects.data" :key="index" class="col-4">
...
export default {
    ...
    methods:{
        getActive_project(page){
            ...
            axios.get(`/api/client_pending/project/${this.id}?page=` + page).then(response => {
